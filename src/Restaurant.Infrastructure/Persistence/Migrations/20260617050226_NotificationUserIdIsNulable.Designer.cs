...
namespace Restaurant.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260617050226_NotificationUserIdIsNulable")]
    partial class NotificationUserIdIsNulable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Dish", b =>
                {
                    ...
                    b.HasIndex("MediaPicId");

                    b.ToTable("Dishes", (string)null);
                });

            modelBuilder.Entity("Restaurant.Domain.Entities.DishMedia", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DishMedias");
                });

            modelBuilder.Entity("Restaurant.Domain.Entities.DishMediaRelation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("DishMediaRelations");
                });

            modelBuilder.Entity("Restaurant.Domain.Entities.Group", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.UserGroupRelation", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Dish", b =>
                {
                    ...
                    b.HasOne("Restaurant.Domain.Entities.DishMedia", "MediaPic")
                        .WithMany()
                        .HasForeignKey("MediaPicId");

                    b.Navigation("Category");

                    b.Navigation("MediaPic");
                });
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.DishMediaRelation", b =>
                {
                    ...
                    b.HasOne("Restaurant.Domain.Entities.DishMedia", "Media")
                        .WithMany()
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.UserGroupRelation", b =>
                {
                    b.HasOne("Restaurant.Domain.Entities.Group", "Group")
                        .WithMany()
